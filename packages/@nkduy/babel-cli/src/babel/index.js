...
require("@nkduy/babel-core");

const fs         = require("fs");
const commander  = require("commander");
const kebabCase  = require("lodash/kebabCase");
const options    = require("@nkduy/babel-core").options;
const util       = require("@nkduy/babel-core").util;
...
commander.version(pkg.version + " (@nkduy/babel-core " + require("@nkduy/babel-core").version + ")");
