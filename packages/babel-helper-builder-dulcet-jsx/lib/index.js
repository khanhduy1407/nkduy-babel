...
exports.default = function (opts) {
  ...
  visitor.JSXNamespacedName = function (path) {
    throw path.buildCodeFrameError("Namespace tags are not supported. DulcetJSX is not XML.");
  };
  ...
  function buildElementCall(path, file) {
    path.parent.children = t.dulcet.buildChildren(path.parent);
  ...
  function buildOpeningElementAttributes(attribs, file) {
    ...
    if (typeof useBuiltIns !== "boolean") {
      throw new Error("transform-dulcet-jsx currently only accepts a boolean option for " + "useBuiltIns (defaults to false)");
    }
