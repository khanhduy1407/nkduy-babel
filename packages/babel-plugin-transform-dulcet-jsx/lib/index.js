...
exports.default = function (_ref) {
  ...
  var visitor = (0, _babelHelperBuilderDulcetJsx2.default)({
  ...
  visitor.Program = function (path, state) {
    ...
    var id = state.opts.pragma || "Dulcet.createElement";
    ...
    for (var _iterator = file.ast.comments, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
      ...
      if (matches) {
        id = matches[1];
        if (id === "Dulcet.DOM") {
          throw file.buildCodeFrameError(comment, "The @jsx Dulcet.DOM pragma has been deprecated as of Dulcet 0.12");
        } else {
          break;
        }
      }
...
var _babelHelperBuilderDulcetJsx = require("babel-helper-builder-dulcet-jsx");

var _babelHelperBuilderDulcetJsx2 = _interopRequireDefault(_babelHelperBuilderDulcetJsx);
